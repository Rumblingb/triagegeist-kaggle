...
- Kaggle notebook source: `notebooks/triagegeist_kaggle_ready.py`
- Kaggle notebook upload candidate: `notebooks/triagegeist_kaggle_ready.ipynb`
- Writeup draft: `docs/WRITEUP_DRAFT.md`
- Cover image candidate: `assets/cover_v1.png`
- Cover brief: `docs/COVER_BRIEF.md`
